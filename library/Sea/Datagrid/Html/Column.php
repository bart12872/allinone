...
class Sea_Datagrid_Html_Column extends Sea_Datagrid_Column {
	...
	public function __construct($label, $indexes = null) {
		...
		$this->_cell->addClass('ac');// centrgae par default
		$this->_header = new Sea_Datagrid_Html_TemplateElement($tags['_header']);
		$this->_header->addClass('ac');
	}
	...
	public function align($align) {
		$this->getCell()->removeClass('ac')->removeClass('al')->removeClass('ar');
	    $this->getCell()->addClass('a' . $align{0});// ajout de l'attribut css a la cellule
	    return $this;
	}
